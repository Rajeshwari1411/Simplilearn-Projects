        ...
        static void Main(string[] args)
        {
            ...
            switch (ss)
            {
                case 1:
                    ...
                    string textFile = "C:\\sort and search\\studentdata1.txt";
                    ...
                    File.WriteAllLines("C:\\sort and search\\studentdata2.txt", sorted2.Select(x => x.Key + "," + x.Value).ToArray());
                    ...
                    File.WriteAllLines("C:\\sort and search\\studentdata3.txt", sorted4.Select(x => x.Key + "," + x.Value).ToArray());
                ...
                case 2:
                    ...
                    string[] words = File.ReadAllText("C:\\sort and search\\studentdata1.txt").Split(' ');
